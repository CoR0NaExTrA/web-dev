...
<body>
    ...
    <div class="main-content">
        <div class="publishing-post">
            ...
            <button type="button" class="publish-button" onclick="ValidateForm()">Publish</button>
        </div>
        ...
        <div class="main-information">
            ...
            <div class="main-information__forms">
                <form id="main-form" class="form">
                    <div class="form__box">
                        ...
                        <input id="title" name="title" class="form__box_input" type="text" placeholder=" " value="New Post"/>
                    </div>

                    <div class="form__box">
                        <label class="form__box_text" for="subtitle">Short description</label>
                        <input id="subtitle" name="subtitle" class="form__box_input" type="text" placeholder=" " value="Please, enter any description"/>
                    </div>
                    
                    <div class="form__box">
                        <label class="form__box_text" for="author_name">Author name</label>
                        <input id="author_name" name="author_name" class="form__box_input" type="text" placeholder=" "/>
                        <h3 class="form__box_label-bottom-error">Author name is required.</h3>
                    </div>
                    
                    <div class="form__box">
                        <label class="form__box_text" for="author-avatar">Author Photo</label>
                        <div class="form__box_author-avatar">   
                            <div id="author-avatar-img" class="form__box_avatar-img">
                                <img id="icon-camera" class="form__box_avatar-icon" src="images/camera.svg" alt="Author avatar"/>
                            </div>
                            <input id="author-avatar" name="author-avatar" type="file" class="form__box_avatar-btn" accept=".jpg, .jpeg, .png, .gif"/>
                            <label id="photo-label"for="author-avatar">
                            ...
                            <div id="delete-photo" class="delete-photo">
                                ...
                                <label class="delete-post-img_label" for="author-avatar">
                    ...
                    <div class="form__box">
                        ...
                        <div id="big-img" class="form__box_post-img__area">
                            <div class="form__box_post-img__button">
                                <div class="form__box_post-img__button-title">
                                    <input id="post-img" name="post-img" type="file" class="form__box_avatar-btn" accept=".jpg, .jpeg, .png, .gif"/>
                        ...
                        <h6 class="form__box_post-img_description" id="post-img-desc">Size up to 10mb. Format: png, jpeg, gif.</h6>
                    ...
                    <div class="form__box">
                        <label class="form__box_text" for="preview-img">Hero Image</label>
                        <div id="small-img" class="form__box_preview-img__area">
                            <div class=".form__box_preview-img__button">
                                <div class="form__box_post-img__button-title">
                                    <input id="preview-img" name="preview-img" type="file" class="form__box_avatar-btn" accept=".jpg, .jpeg, .png, .gif"/>
                                    <label class="form__box__button_label" for="preview-img" id="small-img-label">
                                        <img src="images/camera.svg" alt="icon camera"/>
                                        <span class="form__box_post-img__button_text">Upload</span>
                                    </label>
                                </div>
                        ...
                        <h6 class="form__box_post-img_description" id="preview-img-desc">Size up to 5mb. Format: png, jpeg, gif.</h6>
                        <div id="delete-preview-img" class="delete-preview-img">
                            <img class="form__box__button-icon" src="images/camera.svg" alt="icon camera"/>
                            <label class="delete-preview-img_label" for="preview-img">
                    ...
                    <div class="preview__article">
                        ...
                        <div class="preview__article_content">
                            ...
                            <div class="preview__article_header">
                                ...
                                <h6 class="preview__article_header_subtitle" id="article-subtitle-new">Please, enter any description</h6>
                            </div>
                    ...
                    <div class="preview__post-card">
                        ...
                        <div class="preview__post-card_content">
                            ...
                            <div class="preview__post-card_header">
                                ...
                                <h6 class="preview__post-card_header_subtitle" id="post-card-subtitle-new">Please, enter any description</h6>
                            </div>
                            <div class="preview__post-card_info">
                                <div class="preview__post-card_info_image" id="author-avatar-new"></div>
                                <span class="preview__post-card_info_author" id="author-name-new">Enter author name</span>
            ...
            <div class="content">
                ...
                <form class="content__post" id="content__form">
                    ...
                    <textarea class="content__post_input" id="post-content" name="post-content" cols="125" rows="6" placeholder="Type anything you want..."></textarea>
                </form>
            </div>
        </div>
    </div>
